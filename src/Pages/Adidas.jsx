...
export default function Adidas() {
  ...
  function mostrarCards() {
    ...
    setTextoVisualizacao(
      toggle ? "Você viu 24 de 24 produtos" : "Você viu 9 de 24 produtos"
    );
  }
  ...
  return (
    <>
      ...
      <p className={styleAdidas.Informacoes}>
        Bem-vindo à nossa categoria da Adidas! Como verdadeiros sneakerheads,
      ...
      <button onClick={mostrarCards} className={styleAdidas.VerMais}>
        {textoBtn}{" "}
      </button>
      <p>{renderizar}</p>
    </>
